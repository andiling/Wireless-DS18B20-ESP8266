...
module makeBase(width, depth, height, rounding, minimum, side, bottom, mdiameter, mheight, gap) {
    ...
    union(){
        difference() {
            ...
            //bornier2
            translate([iwidth/2,-4-0.5-0.3,bottom+4/*4mm from bottom*/])cube([(width-iwidth)/2,4,6]);
            translate([iwidth/2,+0.5-0.3,bottom+4/*4mm from bottom*/])cube([(width-iwidth)/2,4,6]);
            ...
            //bornier2
            translate([width/2-0.5,-0.3,1])rotate([90,0,90])linear_extrude(0.5)text(text="PWR",font="Liberation Sans:style=Bold",size=3.5,halign="center");
            translate([width/2-0.5,-0.3-7.5,7.2])rotate([90,0,90])linear_extrude(0.5)text(text="-",font="Liberation Sans:style=Bold",size=6,halign="center");
            translate([width/2-0.5,-0.3+7.5,7])rotate([90,0,90])linear_extrude(0.5)text(text="+",font="Liberation Sans:style=Bold",size=6,halign="center");


            //bornier3
            translate([-width/2+0.5,0,1])rotate([90,0,-90])linear_extrude(0.5)text(text="1WIRE",font="Liberation Sans:style=Bold",size=3.5,halign="center");
            translate([-width/2+0.5,-8.4,10.2])rotate([90,0,-90])linear_extrude(0.5)text(text="-",font="Liberation Sans:style=Bold",size=5.5,halign="center");
            translate([-width/2+0.5,0,12])rotate([90,0,-90])linear_extrude(0.5)text(text="DATA",font="Liberation Sans:style=Bold",size=2.2,halign="center");
            translate([-width/2+0.5,8.4,9.7])rotate([90,0,-90])linear_extrude(0.5)text(text="+",font="Liberation Sans:style=Bold",size=5.5,halign="center");
        ...
        translate([_pcbX/2-3-3.5,idepth/2-6,bottom])cube([3,6,2]);
        translate([_pcbX/2-3-3.5,-idepth/2,bottom])cube([3,6,2]);
...
module makeLid(width, depth, rounding, minimum, side, bottom, mdiameter, mheight, gap, overlap) {
	...
	difference() {
		union() {
            ...
            //WirelessDS18B20 Additions
            //buttons
            translate([-_pcbX/2+4.5,-9.1-0.3,0])cylinder(d=6.5,h=10.5+bottom);
            translate([-_pcbX/2+4.3,9.3-0.3,0])cylinder(d=6.5,h=10.5+bottom);
        ...
        //buttons
        translate([-_pcbX/2+4.5,-9.1-0.3,0])cylinder(d=4,h=10.5+bottom);
        translate([-_pcbX/2+4.3,9.3-0.3,0])cylinder(d=4,h=10.5+bottom);

        //bornier2
        translate([-_pcbX/2+3.81,2.5-0.3,0])cylinder(d=4.5,h=bottom);
        translate([-_pcbX/2+3.81,-2.5-0.3,0])cylinder(d=4.5,h=bottom);
        ...
        //ESP leds
        translate([-_pcbX/2+9.6,5.6-0.3,0.25])cylinder(d=1.5,h=bottom-0.25);
        //translate([-_pcbX/2+9.6,5.6-0.3,0])cylinder(d=1.5,h=0.5);
        translate([-_pcbX/2+12.6,5.6-0.3,0.25])cylinder(d=1.5,h=bottom-0.25);
        //translate([-_pcbX/2+12.6,5.6-0.3,0])cylinder(d=1.5,h=0.5);
        ...
        */
        ...
        //Brand :-)
        translate([5,-13,0.5])rotate([0,-180,-90])difference(){
            linear_extrude(0.6)offset(r=0.7)text(text="WirelessDS18B20",font="Liberation Sans:style=Bold",size=2.4,halign="left");
            linear_extrude(0.6)text(text="WirelessDS18B20",font="Liberation Sans:style=Bold",size=2.4,halign="left");
        }
